...
if world:
    ...
    from turtlebot_hiro.scripts.respawnGoal_origins import Respawn
import copy
...
class Env():
    ...
    def reset(self):
        ...
        if self.initGoal:
            self.goal_x, self.goal_y = self.respawn_goal.setPosition()
            
            self.initGoal = False
        else:
            self.goal_x, self.goal_y = self.respawn_goal.setPosition(delete=True)
